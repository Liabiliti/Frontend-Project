...
<body>
  ...
  <form action="create.php?data=" class="form">
    ...
    <div class="form__group">
      <input type="text" id="ChildFirstName" name="ChildFirstName" class="form__input" placeholder=" " pattern="^[a-zA-Z\s]*$" required title="Input does not accept numbers or special characters" autocomplete="off">
      <label for="AllergyName" class="form__label">Child First Name</label>
    </div>
    <div class="form__group">
      <input type="text" id="ChildLastName" name="ChildLastName" class="form__input" placeholder=" " pattern="^[a-zA-Z\s]*$" required title="Input does not accept numbers or special characters" autocomplete="off">
