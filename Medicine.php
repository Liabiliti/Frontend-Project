...
<body>
  ...
  <form action="create.php?data=" class="form">
    <h1 class="form__title">Medicine</h1>
    <p class="form__description">Create, read, update and delete medicine information</p>
    <div class="form__group">
      <select class="form__input" id="MedicineType" name="MedicineType" placeholder=" " autocomplete="off">
      ...
      <label for="MedicineType" class="form__label">Medicine Type</label>
  </div>
    <div class="form__group">
      <input type="text" id="MedicineName" name="MedicineName" class="form__input" placeholder=" " pattern="[a-zA-Z]+" required title="Input does not accept numbers" autocomplete="off">
      <label for="MedicineName" class="form__label">Medicine Name</label>
    </div>
    <div class="form__group">
      <input type="text" id="MedicineDescription" name="MedicineDescription" class="form__input" placeholder=" " pattern="^[\.a-zA-Z,!? ]*$" required title="Input does not accept numbers" autocomplete="off">
      <label for="MedicineDescription" class="form__label">Medicine Description</label>
    </div>
