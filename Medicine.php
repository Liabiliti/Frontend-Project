...
<body>
  <form action="create.php?data=" class="form">
    ...
    <div class="form__group">
      <input type="text" id="MedicineName" name="MedicineName" class="form__input" placeholder=" " autocomplete="off">
      <label for="MedicineName" class="form__label">Medicine Name</label>
    </div>
    <div class="form__group">
      <input type="text" id="MedicineDescription" name="MedicineDescription" class="form__input" placeholder=" " autocomplete="off">
